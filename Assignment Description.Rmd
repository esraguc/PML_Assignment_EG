...
I checked the correlation of variables in training dataset using FPC
```{r}
corMatrix <- cor(training[, -53])
corrplot(corMatrix, order = "FPC", method = "color", type = "lower", 
         tl.cex = 0.8, tl.col = rgb(0, 0, 0))
```
There are few variables that are highly correlated (negative correlations is dark red(-1) and positive correlation is dark blue(1)) therefore I havent checked the data using PCA plot. 
